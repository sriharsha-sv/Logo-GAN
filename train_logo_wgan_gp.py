...
img_paths = glob.glob('./data/logos/*.jpg')
...
# summary writer
summary_writer = tf.summary.FileWriter('./summaries/logo_wgan_gp', sess.graph)

''' initialization '''
ckpt_dir = './checkpoints/logo_wgan_gp'
...
try:
    ...
    for it in range(sess.run(it_cnt), max_it):
        ...
        if (it + 1) % 100 == 0:
            ...
            save_dir = './sample_images_while_training/logo_wgan_gp'
